...
public class vocabularyController implements Initializable {
    ...
    private void saveProgress() throws IOException {
        FileWriter fw = new FileWriter("src/main/resources/textFiles/progressVocab");
    ...
    private void getProgressBarInfo() throws IOException {
        FileReader fr = new FileReader("src/main/resources/textFiles/progressVocab");
    ...
    private void nextQuestion() {
        ...
        for (int i = 1 ; i < buttons.length ; i++ ){
            int index = (rand + 2 * i) % 50 ;
            String[] tmp = pairsList.get(index).split("\\|") ;
